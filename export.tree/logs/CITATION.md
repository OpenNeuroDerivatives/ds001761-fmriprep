...
: A total of 8 T1-weighted (T1w) images were found within the input
BIDS dataset.
...
8 T1w images (after INU-correction) using
...
: For each of the 117 BOLD runs found per subject (across all
